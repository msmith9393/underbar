(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(accumulated, current) {
      if (!accumulated) {
        return accumulated;
      } else {
        return accumulated = !!iterator(current);
      }
    }, true);
  };
  ...
  _.extend = function(source) {
    var otherObjs = Array.prototype.slice.call(arguments, 1);
    _.each(otherObjs, function(obj) {
  ...
  _.shuffle = function(array) {
    ...
    _.each(copy, function(elem, index, arr) {
  ...
  _.invoke = function(collection, functionOrKey, args) {
    return _.map(collection, function(elem) {
      if (typeof functionOrKey === "function") {
        ...
        return elem[functionOrKey](args);
      }
    });
  };
  ...
  _.flatten = function(nestedArray, result) {
    return _.reduce(nestedArray, function(flatArr, elem) {
